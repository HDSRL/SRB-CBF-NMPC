...
{   
    ...
    std::string mpc_log_filename = "///home/hdsrl7/Desktop/A1_RaiSim_Outputs/EXB_E_MPC_LOG_AGENT_" + std::to_string(log_ID) + ".txt";
    std::string qp_log_filename = "///home/hdsrl7/Desktop/A1_RaiSim_Outputs/EXB_E_QP_LOG_AGENT_" + std::to_string(log_ID) + ".txt";
...
{
    double c = 550.0, m = 8.0, epsilon = 50, sigma = 0.85;
...
void MPC_dist::setPobs(Eigen::Matrix<double, 2,9>& Pobs_in)
{
    Pobs << Pobs_in;
}

void MPC_dist::setPobs_real(Eigen::Matrix<double, 2,9>& Pobs_in)
{
    Pobs_real << Pobs_in;
}
